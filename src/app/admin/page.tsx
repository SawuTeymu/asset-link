 ...
 * 狀態：V300.45 物理除錯版 (修復 400 Bad Request)
 * 職責：
 * 1. 欄位對正：將 historical_assets 的排序欄位從 created_at 修正為「建立時間」。
 * 2. 實體對齊：完全鎖定「資產」與「historical_assets」雙資料表。
 * ==========================================
 */
...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      ...
      // 2. 獲取已結案總數 (🚀物理修正：將 created_at 改為 建立時間 解決 400 報錯)
