...
// 🚀 新增引入 Server Action 確保計價動作有 Log
 ...
 * 狀態：V400.2 網點計價結算 (日誌防護完整版)
 * 職責：
 * 1. 歷史庫查詢：從 historical_assets 讀取已結案資產，進行 NSR 計價結算。
 * 2. 🚀 日誌綁定：所有計價動作強制走 Server Action 寫入 system_logs。
 * ==========================================
 */
